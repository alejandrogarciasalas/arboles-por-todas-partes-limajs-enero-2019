...
Link: [https://arboles-por-todas-partes.netlify.com/](https://arboles-por-todas-partes.netlify.com/)
---
...
Un parser toma código (texto) "rompe" su estructura en pedazos más pequeños llamado tokens y arma una estructura de datos con estos pedazos.
